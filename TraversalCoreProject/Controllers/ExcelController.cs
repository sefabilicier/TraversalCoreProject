...
namespace TraversalCoreProject.Controllers
{
    public class ExcelController : Controller
    {
        ...
        {
            return File(_excelService.ExcelList(DestinationList()), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "YeniExcel.xlsx");                                                    //content type
        }
        ...
        public IActionResult DestinationExcelReport()
        {
            ...
            {
                var workSheet = workbook.Worksheets.Add("Tour Lists");
